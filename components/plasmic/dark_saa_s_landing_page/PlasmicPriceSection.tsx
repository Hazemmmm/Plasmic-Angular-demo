...
import sty from "./PlasmicPriceSection.module.css"; // plasmic-import: JVifp2VzupyUzW/css
    ...
    >
      {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__zxp2W)}
        >
          {true ? (
            <div className={classNames(projectcss.all, sty.freeBox__tnPLa)}>
              <PriceCard
                borders={["flatLeft"]}
                className={classNames("__wab_instance", sty.priceCard___9Au5Z)}
              />
            </div>
          ) : null}

          {true ? (
            <div className={classNames(projectcss.all, sty.freeBox__fjYdk)}>
              <div className={classNames(projectcss.all, sty.freeBox__zfDyU)}>
                <div
              ...
              {(
                ...
                <PriceCard
                  borders={["flatCenter"]}
                  className={classNames("__wab_instance", sty.priceCard__ua0XL)}
                />
              ) : null}
            </div>
          ) : null}
          ...
          {true ? (
            <div className={classNames(projectcss.all, sty.freeBox__exXyU)}>
              <PriceCard
                borders={
                ...
                className={classNames("__wab_instance", sty.priceCard__uDam)}
              />
            </div>
          ) : null}
        </p.Stack>
