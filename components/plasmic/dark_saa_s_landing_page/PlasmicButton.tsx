...
import sty from "./PlasmicButton.module.css"; // plasmic-import: AJ2OtggAtTstX/css
    ...
    >
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__tI0UT)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__vlTwC)}
                role={"img"}
              />
            ),
