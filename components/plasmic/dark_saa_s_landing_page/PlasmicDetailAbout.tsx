...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: Rj_4a4yhRN7rgo/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__xXHb)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column__i7Swm)}>
            <h5
